...
//   <p className='text-ig font-semibold '>{item.show.movie.title}</p>
//   <p className='text-gray-400 text-semibold ' >{timeFormat(item.show.movie.runtime)}</p>
...
//   {!item.isPaid && <button className="bg-red-600 text-white px-4 py-1.5 mb-3 text-sm rounded-full cursor-pointer">
//     Pay now</button>}
// </div>
